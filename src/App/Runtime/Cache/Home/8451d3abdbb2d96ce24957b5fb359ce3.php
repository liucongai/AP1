...
<link rel="stylesheet" type="text/css" href="/AP1/Public/css/saved_resource_l2.css" />
        ...
        <div class="content">
            ...
            <div id="js-pub-container" class="issques clearfix js-form">
                <div class="wgt-ipt-wrap pub-editor-wrap " id="js-pl-input-fake">
                    ...
                    <p><input  type="hidden" name="zz_id" value="<?php echo ($lesson["id"]); ?>" /></p>
        ...
        <a href="javascript:;" class="verify-refresh js-verify-refresh">换一换</a>
            ...
            <div id="course_note">
                ...
                <ul class="mod-post" id="comment-list">
                    <?php if(is_array($comlist)): foreach($comlist as $key=>$cval): ?><li class="post-row">
                        <div class="media">
                            <a href="我的慕课" target="_blank"><img  src='/AP1/Uploads/<?php echo ($cval['user_pic']); ?>' width='40' height='40' /></a>
                        </div>
                        <div class="bd">
                            <div class="tit">
                                <a href="/space/u/uid/2532666" target="_blank"><?php echo ($cval['user_name']); ?></a>
                            </div>
                            <p class="cnt"><?php echo ($cval['comment']); ?></p>
                            <div class="footer clearfix">
                                <span title="创建时间" class="l timeago">时间：<?php echo ($cval['time']); ?></span>
                                <a href="/video/10497" class="from">源自：<?php echo ($cval['zname']); ?></a>
                                <div class="actions r">
