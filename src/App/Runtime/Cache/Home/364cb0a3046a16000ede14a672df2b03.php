    ...
    <div class="wwrap  wrap-boxes">
        ...
        <div class="cprofile-wrap">
            <div class="cprofile-inner clearfix">
                <div style="margin-left:-80px" class="avator-wrap l">
                    <div class="avator-img l">
            <div><img src='/AP1/Uploads/<?php echo ($img["name"]); ?>'/></div>
            <div>
            <form action="<?php echo U('complete');?>" method="post" enctype="multipart/form-data">
              ...
              <tr>
                <td>
                    ...
                    <input type="submit" style="margin-left:-50x;width: 120px;height: 30px;line-height:30px;font-size: 14px;font-family: '微软雅黑';padding: 0;margin: 0;border: 1px solid #04d;background:#6098D5; " value="上传" /> 
                </td>
              </tr>
                ...
                <div class="cprofile-field-wrap">
                    <form id="cprofile" action="<?php echo U('complete');?>" method="get">
                        <div class="wlfg-wrap">
                            <label class="label-name" for="nick">昵称</label>
                            <div class="rlf-group">
                                <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>" />
                                <input type="text" name="nick"value="<?php echo ($list["nick"]); ?>" id="nick" autocomplete="off" data-validate="nick" class="rlf-input rlf-input-nick" value="{list.nick}" placeholder="请输入昵称.">
                        ...
                        <div class="wlfg-wrap">
                            <div class="rlf-group">
                                <input type="submit" style="width:180px" id="profile-submit" aria-role="button" class="rlf-btn-green btn-block profile-btn" value="保存" />
                            </div>
                        </div>
                    </form>
                    <div class="wlfg-wrap">
                        <div class="rlf-group">
                            <a href="<?php echo U('Index/index');?>"><button style="width:180px;margin-top:20px" aria-role="button" class="rlf-btn-green btn-block profile-btn" >开始学习</button></a> 
                        </div>
                    </div>    
                </div>
            </div>
