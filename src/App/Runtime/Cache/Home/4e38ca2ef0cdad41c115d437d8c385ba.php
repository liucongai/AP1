        ...
        <div class="main">
            <div class="ww">
                ...
                <div style="display:inline;" class="myclub-main fr">
                    ...
                    <!--回答-->
                    <div style="display:inline;" class="wd-reply">
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><div class="wd-pre2">
                            ...
                            <div class="wd-l fl">
                                ...
                                <span>[我的回答]:<?php echo ($val["answ"]); ?></span>
                                <div style="margin-top:10px;" class="wd-addon">
                             ...
                             <div class="actques  fr">
                                 <a class="btn btn-primary" href="<?php echo U('Interlocution/detail','bw=1&id='.$val['ques_id']);?>">查看回答</a>
                                <a class="btn btn-success" href="<?php echo U('delans','id='.$val['ans_id']);?>">删除回答</a> 
                            </div>
                            <div class="wd-r fr">                
...
<div style="height:250px;" class="clear"></div>
