...
<div class="corp-container">
    <div class="corp-banner" style="background:<?php echo ($share["color"]); ?>">
        <div class="corp-banner-inner">
          
            <div class="corp-pro-logo text-center">
                <img src="/AP1/Uploads/<?php echo ($share['img_big']); ?>" class="corp-pro-img"><i></i>
            </div>
          
            <div class="corp-items">
                <ul style="" class="clearfix">
                   <?php if(is_array($list)): foreach($list as $key=>$val): ?><li id="<?php echo ($val["id"]); ?>" class="item ">
    ...
    <div class="corp-content">
        <div class="corp-layout clearfix">
            ...
            <div class="corp-take-in">
                    <h2 class="corp-h2">介绍</h2>
                    <p class="corp-words">
                        <?php echo ($share["intro"]); ?>
                    </p>
                   </div>                     
            </div>
        </div>
