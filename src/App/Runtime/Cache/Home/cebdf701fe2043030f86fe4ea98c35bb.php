                ...
                <div style="display:inline;" class="myclub-main fr">
                    ...
                    <div style="display:inline;" class="wd-ques">
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><div class="wd-pre">
                            ...
                            <div class="wd-l fl">
                                <h4><i class="glyphicon glyphicon-question-sign" ></i><a href="<?php echo U('Interlocution/detail','bw=1&id='.$val['id']);?>"><?php echo ($val["title"]); ?></a></h4>
                                <div class="wd-addon">
                            ...
                            <div class="actques  fr">
                                <a class="btn btn-primary" href="<?php echo U('Interlocution/detail','bw=1&id='.$val['id']);?>">查看帖子</a>
                                <a class="btn btn-success" href="<?php echo U('delques','id='.$val['ans_id']);?>">删除帖子</a> 
                            </div>
                            <div style="display:inline;" class="wd-r fr">                
                                <a href="<?php echo U('Interlocution/detail','bw=1&id='.$val['id']);?>">
                                    <div class="ans-wen">
