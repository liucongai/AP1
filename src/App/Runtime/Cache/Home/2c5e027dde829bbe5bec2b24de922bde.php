...
<link rel="stylesheet" type="text/css" href="/AP1/Public/css/saved_resource_sp2.css" />
...
<div class="r space-main">
    ...
    <div class="myspace-courselist myspace-bg r">
        <div class="main-bd clearfix" id="J_MyClass" data-type="0">
            <div class="js-course-list my-space-course study-tl">

                <?php if(is_array($list)): foreach($list as $key=>$val): ?><div class="clearfix tl-item  tl-item-first">
                        <span class="time">
                           <?php echo ($val[0]['time']); ?>
                        </span>
                        <div class="course-list course-list-m three-colum">
                            <ul class="clearfix">
                                ...
                                <?php if(is_array($val)): foreach($val as $key=>$pat): ?><li class="course-one" data-id="528">
                                        <a href="http://www.imooc.com/learn/528">
                                            <div class="course-list-img">
                                                <img width="240" height="135" alt="MongoDB复制集—快速搭建复制集" src="/AP1/Uploads/<?php echo ($pat["fimg"]); ?>">
                                                <div class="media-progress">
                                                    <div class="progress-val text-ellipsis"><span><?php echo ($pat["pro"]); ?>%</span></div>
                                                    <div class="mask"></div>
                                                    <div class="progress-bar">
                                                        <div class="bar" style="width: 0%"></div>
                                                    </div>
                                                </div>
                                                <i class="btn-add-collection btn-remove-collection"></i>
                                            </div>
                                            <h5>
                                                <span><?php echo ($pat["name"]); ?></span>
                                            </h5>
                                            <div class="tips">
                                                <p class="text-ellipsis"><?php echo ($pat["desc"]); ?></p>
                                                <span class="l  update-latest "><?php echo ($pat["progress"]); ?></span>
                                                <span class="l ml20"><?php echo ($pat["per_num"]); ?>人学习</span>
                                            </div>
                                            <span class="time-label"><?php echo ($pat["nandu"]); ?></span>
                                        </a>
                                        <span class="del"></span>
