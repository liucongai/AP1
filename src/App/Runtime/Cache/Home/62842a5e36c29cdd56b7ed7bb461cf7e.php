...
<div class="r space-main">
    ...
    <div class="myspace-courselist myspace-bg">
        ...
        <ul class="clearfix">
            <?php if(is_array($lesson)): foreach($lesson as $key=>$val): ?><li class="course-one" onclick="lesson(this)" style="height:240px;cursor:hand">
        ...
        <div class="add_zhang" style="width: 500px;display: none">
            <form action="<?php echo U('zhangadd');?>" enctype="multipart/form-data" method="post">
                <input type="hidden" name="lesson_id" value="<?php echo ($_SESSION['home']['id']); ?>" class="get_lesson">
                <div class="wlfg-wrap">
...
<script>
    ...
    function lesson(ob){
        ...
        $.get('<?php echo U("ajaxNamex");?>',{id:$(ob).next().text()},function(result){
            // console.dir($(result));
