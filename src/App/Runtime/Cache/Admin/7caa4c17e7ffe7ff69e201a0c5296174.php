            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="<?php echo U('add');?>" method="post" enctype="multipart/form-data" />
                                ...
                                <div class="span12 field-box">
                                    <label>Pid:</label>
                                    <input class="span9" name="pid" type="text" value="<?php echo ($pid); ?>" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Path:</label>
                                ...
                                <div class="span12 field-box">
                                    <label>Tag-img:</label>
                                    <input  class="span7" name="tag-img" type="file" value="分类图片"/>
                                    <span id="span1"></span>
                                </div>
                                 
                                <div class="span12 field-box">
                                    <label>Content:</label>
                                    <input class="span9" name="content" type="text" />
                                </div>

                                <div class="span11 field-box actions">
                                    <input type="submit" class="btn-glow primary" value="Create Catergory" />
                                    <span>OR</span>
                    ...
                    <div class="span3 form-sidebar pull-right">
                        ...
                        <ul>
                            <li><a href="<?php echo U('Category/index');?>">Category_list</a></li>
