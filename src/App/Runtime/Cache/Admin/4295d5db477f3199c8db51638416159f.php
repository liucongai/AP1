        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                    ...
                    <ul class="breadcrumb" style="margin:-40px 0 50px 0">
                       <li><a href="<?php echo U('User/index');?>">User</a> <span class="divider">/</span></li>
                       <li class="active">User_list</li>
                    </ul>
                    ...
                    <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th class="span2 sortable">
                                 ...
                                 <th class="span5 sortable">
                                    <span class="line"></span>Job
                                </th>
                                 <th class="span3 sortable">
                                    <span class="line"></span>Address
                                </th>
                                <th class="span6 sortable">
                                    <span class="line"></span>Sign
                                </th>

                                <th class="span5 sortable align-right">
                        ...
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                            ...
                            <td class="align-right">
                               <a  class=""  	 href="<?php echo U('del',array('id'=>$val['id']));?>"   onclick="return confirm('确定要删除？')"> <i class="icon-trash icon-white"></i>删除</a>
				            <a class="" href="<?php echo U('edit',array('id'=>$val['id']));?>"><i class="icon-edit icon-white"></i>编辑</a>
                            </td>
