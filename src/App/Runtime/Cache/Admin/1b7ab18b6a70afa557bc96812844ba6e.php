                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                                ...
                                <th class="span3 sortable">
                                 ...
                                 <th class="span3 sortable">
                                  ...
                                  <th class="span2 sortable">
                                     <span class="line"></span>color
                                </th>
                                  <th class="span5 sortable">
                                     <span class="line"></span>img_big
                                </th>
                                 <th class="span6 sortable">
                                     <span class="line"></span>intro
                                </th>
                        ...
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                            ...
                            <td><img src="/AP1/Uploads/<?php echo ($val["img"]); ?>"></td>
                            <td><?php echo ($val["color"]); ?></td>
                            <td><img src="/AP1/Uploads/<?php echo ($val["img_big"]); ?>"></td>
                            <td><?php echo ($val["intro"]); ?></td>
                
                            <td>
                                <a href="<?php echo U('edit?id='.$val[id]);?>">编辑分享</a>&nbsp;&nbsp;
                                <a href="<?php echo U('del?id='.$val[id]);?>">删除分享</a>&nbsp;&nbsp;
