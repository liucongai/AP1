            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="<?php echo U('doadd');?>" method="post" enctype="multipart/form-data"/>
                                <div class="span12 field-box">
                                    <label>Share_name:</label>
                                ...
                                <div class="span12 field-box">
                                    <label>bgcolor:</label>
                                    <input id="check1" class="span7" name="color" type="text" />
                                    <span id="span1"></span>
                                </div>

                                 <div class="span12 field-box">
                                    <label>Share_img:</label>
                                    <input  class="span7" name="img" type="file" value="分享图片"/>
                                    <span id="span1"></span>
                                </div>

                                <div class="span12 field-box">
                                    <label>Share_img_big:</label>
                                    <input  class="span7" name="img_big" type="file" value="分享图片"/>
                                    <span id="span1"></span>
                                </div>
                                ...
                                <div class="span12 field-box textarea">
                                    <label>Intro:</label>
                                    <textarea name="intro"class="span9"></textarea>
                    ...
                    <div class="span3 form-sidebar pull-right">
                        ...
                        <ul>
                            <li><a href="<?php echo U('Share/index');?>">Share_list</a></li>
                            <li><a href="<?php echo U('Share/add');?>">Share_add</a></li>
                        </ul> 
                    </div>
                </div>
            </div>
