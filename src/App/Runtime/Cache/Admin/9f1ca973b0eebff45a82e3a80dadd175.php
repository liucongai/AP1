         ...
         <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                    ...
                    <ul class="breadcrumb" style="margin:-40px 0 50px 0">
                       <li><a href="<?php echo U('Suggest/index');?>">Suggest</a> <span class="divider">/</span></li>
                       <li class="active">Suggest_list</li>
                    </ul>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="span3 sortable">
                                    <span class="line"></span>Suggest
                                </th>
                                 <th class="span3 sortable">
                                    <span class="line"></span>cont_info
                                </th>
                                 <th class="span3 sortable">
                                     <span class="line"></span>replay
                                </th>
                                <th class="span3 sortable">
                        ...
                        <tbody>
                            <!-- row -->
                        <?php if(!empty($suggest)): if(is_array($suggest)): foreach($suggest as $key=>$val): ?><tr>
                            <td><?php echo ($val["id"]); ?></td>
                            <td><?php echo ($val["suggest"]); ?></td>
                            <td><?php echo ($val["cont_info"]); ?></td>
                            <td><?php echo ($val["reply"]); ?></td>
                            <td><a href="<?php echo U('state',array(id=>$val['id'],state=>$val['state']));?>"><?php echo ($val["state"]); ?></a></td>
                            <td><?php echo ($val["user_id"]); ?></td>
                            <td><?php echo date( 'Y-m-d H:i:s', $val['cre_time']) ?></td>
                
                            <td>
                                <a href="<?php echo U('edit?id='.$val[id]);?>">回复意见</a>&nbsp;&nbsp;
                                <a href="<?php echo U('del?id='.$val[id]);?>">删除意见</a>&nbsp;&nbsp;
