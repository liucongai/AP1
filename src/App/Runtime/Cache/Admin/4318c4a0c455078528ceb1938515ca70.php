            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="<?php echo U('edit');?>" method="post" />
                                ...
                                <div class="span12 field-box">
                                    <label>pid:</label>
                                    <input class="span9" name="pid" value="<?php echo ($list["pid"]); ?>" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Path:</label>
                                    <input class="span9" name="path" value="<?php echo ($list["path"]); ?>" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>content:</label>
                                    <input class="span9" name="content" value="<?php echo ($list["content"]); ?>" type="text" />
                                </div>
                                <div class="span11 field-box actions">
                                    <input type="submit" class="btn-glow primary" value="Edit category" />
                                    <span>OR</span>
                    ...
                    <div class="span3 form-sidebar pull-right">
                        ...
                        <ul>
                            <li><a href="<?php echo U('Category/index');?>">Caregory_list</a></li>
                            <li><a href="<?php echo U('Category/add');?>">Category_add</a></li>
                        </ul> 
                    </div>
                </div>
            </div>
