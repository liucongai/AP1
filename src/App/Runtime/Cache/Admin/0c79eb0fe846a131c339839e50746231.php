            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" enctype="multipart/form-data" action="<?php echo U('add');?>" method="post"/>
                                ...
                                <div class="span12 field-box">
                                    <label>Pid:</label>
                                    <input class="span9 mask1" name="pid" type="text" value="<?php echo ($pid); ?>" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Path:</label>
                                    <input class="span9" name="path" type="text" value="<?php echo ($path); ?>"/>
                                </div>

                                <div class="span12 field-box textarea" >
                                    <label>Describe:</label>
                                    <textarea class="span9" type="text" name="desc" placeholder="" ></textarea>
                                </div>

                                <div class="span12 field-box mask2" style="display: none">
                    ...
                    <div class="span3 form-sidebar pull-right">
                        ...
                        <ul>
                            <li><a href="<?php echo U('Plan/index');?>">Category_list</a></li>
                            <li><a href="<?php echo U('Plan/add');?>">Category_add</a></li>
                        </ul> 
                    </div>
                </div>
            </div>
