...
class Qiniu{
    ...
    private $config = array(
        'secretKey'     => '5xQuDy_sh3hnUgu2gN7Ubq8E-JDF2pP_HaA73VpV', //七牛服务器
        'accessKey'      => 'Lso-ZttN0Z_8Od107ilrC7lJo7psvRWdlgZNcSgB', //七牛用户
        'domain'         => 'yanqingju.qiniudn.com', //七牛密码
        'bucket'         => 'yanqingju', //空间名称
        'timeout'        => 300, //超时时间
    );
