         ...
         <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                    ...
                    <ul class="breadcrumb" style="margin:-40px 0 50px 0">
                       <li><a href="<?php echo U('Category/index');?>">Category</a> <span class="divider">/</span></li>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th id="content" class="span4 sortable">
                                     <span class="line"></span>content
                                </th>
                                <th id="pig_h" class="span3 sortable">
                                     <span class="line"></span>tag-img
                                </th>
                                <th class="span7">
                                    <span class="line"></span>Action
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    
                                    <span style="font-size:15px"><a href="<?php echo U('index',array('pid'=>$gpid['pid']));?>">返回上级</a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                            ...
                            <td><a href="<?php echo U('dis?id='.$val[id].'&display='.$val[display]);?>"><?php echo ($val["display"]); ?></a></td>
                            <td class="content_d"><?php echo ($val["content"]); ?></td>
                            <td class="pig_d"><img  src="/AP1/Uploads/<?php echo ($val["tag-img"]); ?>"/></td>
                            <td>
                                <a href="<?php echo U('edit?id='.$val[id]);?>">编辑分类</a>&nbsp;&nbsp;
                                <a id="son" href="<?php echo U('index?pid='.$val[id]);?>">查看子类</a>&nbsp;&nbsp;
                                <a href="<?php echo U('add?pid='.$val[id].'&path='.$val[path]);?>">添加子类</a>
                                <a href="<?php echo U('del?id='.$val[id]);?>">删除分类</a>
