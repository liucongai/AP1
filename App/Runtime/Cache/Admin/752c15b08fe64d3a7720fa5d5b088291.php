         ...
         <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                    ...
                    <ul class="breadcrumb" style="margin:-40px 0 50px 0">
                       <li><a href="<?php echo U('Article/index');?>">Article</a> <span class="divider">/</span></li>
                       <li class="active">Article_list</li>
                    </ul>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                            ...
                            <td>
                                <a href="<?php echo U('Home/Article/detail','id='.$val[id].'&e=1');?>">查看详情</a>||
                                <a href="<?php echo U('del','id='.$val[id]);?>">删除文章</a>
                            </td>
