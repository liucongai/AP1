            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="<?php echo U('User/doedit');?>" method="post" />
                                <div class="span12 field-box">
                                    <input class="span9" name="id" value="<?php echo ($list["id"]); ?>" type="hidden" />
                                    <label>Name:</label>
                                    <input class="span9" name="name" value="<?php echo ($list["name"]); ?>" type="text" />
                                </div>
                                 <div class="span12 field-box">
                                    <label>Password:</label>
                                    <input class="span9" name="password" value="<?php echo ($list["password"]); ?>" type="password" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Type:</label>
                                    <div class="ui-select span5">
                                        <select name="type">
                                            <option value="0" <?php echo ($list['type'] ==0?'selected':''); ?>/>会员
                                            <option value="1" <?php echo ($list['type'] ==1?'selected':''); ?>/>管理员
                                            <option value="2" <?php echo ($list['type'] ==2?'selected':''); ?> />超级管理员
                                        </select>
                                    </div>
                                </div>
                                <div class="span12 field-box">
                                    ...
                                    <div class="ui-select span5">
                                        <select name="sex">
                                            <option value="0" <?php echo ($list['sex'] ==0?'selected':''); ?> />女
                                            <option value="1" <?php echo ($list['sex'] ==1?'selected':''); ?> />男
                                            <option value="2" <?php echo ($list['sex'] ==2?'selected':''); ?> />保密
                                        </select>
                                    </div>
                                </div>
                                <div class="span12 field-box">
                                    <label>Email:</label>
                                    <input class="span9" name="email" value="<?php echo ($list["email"]); ?>" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Phone:</label>
                                    <input class="span9" name="phone" value="<?php echo ($list["phone"]); ?>" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>job:</label>
                                    <div class="address-fields">
                                        <input class="span9" name="job" value="<?php echo ($list["job"]); ?>" type="text" placeholder="Street address" />
                                    </div>
                                </div>
                                <div class="span12 field-box">
                                    <label>Address:</label>
                                    <div class="address-fields">
                                        <input class="span9" name="address" value="<?php echo ($list["address"]); ?>" type="text" placeholder="Street address" />
                                    </div>
                                </div>
