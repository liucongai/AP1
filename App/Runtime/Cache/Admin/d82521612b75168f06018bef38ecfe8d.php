        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                    ...
                    <ul class="breadcrumb" style="margin:-40px 0 50px 0">
                       <li><a href="<?php echo U('User/index');?>">Interlocution</a> <span class="divider">/</span></li>
                       <li class="active">Interlocution_list</li>
                    </ul>
                    ...
                    <form class="form-search fr" action="" method="get">
                        ...
                        <input type="text" name="user" class="input-medium search-query" placeholder="User">
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                            ...
                            <td><?php echo ($val["zz_id"]); ?></td>
                            <td><?php echo ($val["tag"]); ?></td>
                            <td>
                    <a href="<?php echo U('Home/Interlocution/detail','id='.$val[id].'&e=1');?>">查看详情</a>||
                    <a href="<?php echo U('del','id='.$val[id]);?>">删除帖子</a>
                            </td>
