...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/AP1/Public/css/opus-create.css" />   
     <style type="text/css">
...
<div class="clear"></div>
	...
	<div class="main">
		...
		<div class="opus-main">
			...
			<form action="<?php echo U('docreate');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="qs-yzm  fl">
                ...
                <img id="yzmcode" src="<?php echo U('yzm');?>" alt="验证码" title="点击刷新" onclick="this.src=this.src+'?i='+Math.random()" >   
            </div>
