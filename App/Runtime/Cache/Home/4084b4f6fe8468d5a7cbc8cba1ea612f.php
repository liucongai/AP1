...
<title>活动_慕课社区</title>
    ...
    <link rel="stylesheet" type="text/css" href="/AP1/Public/css/actcopy.css" />
    <link rel="stylesheet" type="text/css" href="/AP1/Public/css/style.css" />
    <link rel="stylesheet" type="text/css" href="/AP1/Public/css/activity1.css" />
    ...
    <div class="activity-main">
        ...
        <div class="activity-header">
            <ul class="activity-type clearfix">
                <li class="acting selected"><a href="<?php echo U('index');?>">正在进行中</a></li>
                <li class="over"><a href="<?php echo U('index?overst=-1');?>">已结束</a></li>
            </ul>
        </div>
        <script>
            ...
            $a=<?php echo ($pd); ?>;
                ...
                $(".activity-type li").eq($a).addClass('selected').siblings().removeClass('selected');
            
        </script>

        <div class="activity-list">
            <ul class="clearfix">
                <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$value): ?><li data-activity-id="120" class="btn-ui">
                    <div class="activity-item">
                        <a href="<?php echo U('detail','bw=1&aid='.$value[id]);?>" target="_blank"><img src="/AP1/Uploads/<?php echo ($value["name"]); ?>" height="161" width="381"></a>
                        <h2 class="txtflow"><a href="<?php echo U('detail','bw=1&aid='.$value[id]);?>" target="_blank"><?php echo ($value["title"]); ?></a></h2>
                        <p><span>活动时间：</span><?php echo ($value["bgtime"]); ?><span>至</span><?php echo ($value["edtime"]); ?><span class="hot">热度 <em class="hot-count"><?php echo ($value["act_bw"]); ?></em></span></p>
                    </div>
    ...
    <div class="activity-aside">
        <div class="active-users">
            ...
            <dl class="active-users-list">
                <dt class="clearfix">
                    <div class="cell photo"><a href="" target="_blank" title="访问笨笨的木鸟的社区"><img src="" height="39" width="39"></a></div>
                    <div class="cell">
                       <a href="" target="_blank" title="访问笨笨的木鸟的社区"><strong class="nickname txtflow">笨笨的木鸟</strong></a>
                       <span class="job-info txtflow" title="学生">学生</span>
                    </div>
                </dt>
                
                <dt class="clearfix">
                    <div class="cell photo"><a href="http://www.imooc.com/myclub/opus?uid=2529282" target="_blank" title="访问a906593498的社区"><img src="%E6%B4%BB%E5%8A%A8_%E6%85%95%E8%AF%BE%E7%A4%BE%E5%8C%BA_files/545868cd00013bbb02200220-40-40.jpg" height="39" width="39"></a></div>
                    <div class="cell">
                       <a href="http://www.imooc.com/myclub/opus?uid=2529282" target="_blank" title="访问a906593498的社区"><strong class="nickname txtflow">a906593498</strong></a>
