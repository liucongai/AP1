...
<div class="r space-main">
    ...
    <div class="course-tool-bar clearfix">
        <div class="tool-left l">
            <a href="<?php echo U('myplan',array('type' => 0));?>" class="sort-item ">加薪利器</a>
            <a href="<?php echo U('myplan',array('type' => 2));?>" class="sort-item ">求职路线</a>
        </div>
    ...
    <div class="myspace-courselist myspace-bg">
        <div class="main-bd clearfix">
            <div class="space-tabs-menu">
                <div class="space-tabs-edit js-program-edit" data-edit="0"></div>    </div>
            <div class="course-list program-medias">
                <ul class="clearfix">

                    <?php if(is_array($info)): foreach($info as $key=>$val): ?><li data-id="32" class="course-one">
                            <a href="<?php echo U('Plan/plandetail',array('id'=>$val['id']));?>">
                                <div class="course-list-img">
                                    <img width="240" height="158" alt="" src="/AP1/Uploads/<?php echo ($val["img"]); ?>">
                                </div>
                                <h5>
                        ...
                        <span class="complete">
                            完成<strong><?php echo ($val["pro"]); ?>%</strong>
                        </span>
                            </a>
                            <span class="del "></span>
