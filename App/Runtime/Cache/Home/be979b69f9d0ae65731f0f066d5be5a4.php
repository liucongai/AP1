            ...
            <div class="ww">
                ...
                <div style="display:inline;" class="myclub-main fr">
                    <div id="nav1" class="wd-nav">
                        <a class="wd-me wd-on" href="<?php echo U('myarticle');?>">我的文章</a>
                        <a class="wd-me" href="<?php echo U('myarticlecare');?>">收藏</a>
                        
                        
                        <a class="wd-new fr" href="<?php echo U('Article/wrt');?>"><i class="glyphicon glyphicon-plus" ></i>写文章</a>
                    </div>
                   ...
                   <div style="display:inline;" class="wd-ques">
                       <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><div class="wd-pre">
                            ...
                            <div class="wd-l fl">
                                <h4><i class="glyphicon glyphicon-book" ></i><a href="<?php echo U('Article/detail','bw=1&id='.$val['id']);?>"><?php echo ($val["title"]); ?></a></h4>
                                <div class="wd-addon">
                                    <span>提问时间:<?php echo ($val["time"]); ?></span>
                                    <span class="wdtag">
                                	
                                    <a class="wdtag-a " href="<?php echo U('Article','pid='.$val['id']);?>"><?php echo ($val["tag"]); ?></a>
                                    
                                </span>
                                </div>
                            </div> 
                            <div class="actques  fr">
                                <a class="btn btn-primary" href="<?php echo U('Article/detail','bw=1&id='.$val['id']);?>">查看文章</a>
                                <a class="btn btn-success" href="<?php echo U('delart','id='.$val['id']);?>">删除文章</a> 
                            </div>
                            <div class="wd-r fr">                
                                <a href="<?php echo U('Article/detail','bw=1&id='.$val['id']);?>">
                                    <div class="ans-wen">
