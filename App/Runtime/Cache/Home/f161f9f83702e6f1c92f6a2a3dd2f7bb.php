...
<link rel="stylesheet" type="text/css" href="/AP1/Public/css前台/about/a.css" />
     <link rel="stylesheet" type="text/css" href="/AP1/Public/css前台/about/suggest.css" />
<div id="main">
...
<div class="others clearfix">
    ...
    <div class="feedback-wrap">
        ...
        <div class="field-wrap">
            <form action="<?php echo U('suggest2');?>" method="post" >
            <div>
                <textarea name="suggest" id="info" class="phd" cols="30" rows="10" placeholder="骚年，哪有不爽，来喷吧！"></textarea>
                <p class="rlf-tip-wrap"></p>
            </div>
            <div>
                <input type="text" name="cont_info" id="contact" class="phd" placeholder="请留下真实联系方式（邮箱、QQ），方便我们答疑解惑！">

                <p class="rlf-tip-wrap"></p>
            </div>
            <div class="btn-wrap">
                <button><input  type="submit"  id="submit" class="r" value="" onclick="dosubmit();">提交</button>
      ...
      <div class="qqGroup-feed">
        ...
        <div class="feedback-content">
            <ul class="feedback-nav clearfix tip">
                <li >
                    <a href="<?php echo U('suggest1');?>">我的反馈</a>
                </li>
                <li class="selected">
                    <a href="<?php echo U('suggest2');?>">其它反馈</a>
                </li>
            </ul>
            <ul class="feedback-list" id="feedback-list">
                
                <?php if(is_array($list)): foreach($list as $key=>$val): ?><li class="feedback-item">
                    <p class="text"><?php echo ($val["suggest"]); ?></p>
                    <p class="time"><?php echo date( 'Y-m-d H:i:s', $val['cre_time'])?>提出</p>
                    <p class="reply">
                    <span class="imooc-manager">慕课网产品经理：</span>
                      <?php echo ($val["reply"]); ?>
                    </p>
