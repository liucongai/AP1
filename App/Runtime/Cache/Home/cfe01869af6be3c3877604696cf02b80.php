...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/AP1/Public/css/article.css" />    
    <script type="text/javascript" src="/AP1/Public/js/jquery.cookie.js"></script>   
    <style type="text/css">
        #nav1  {border-top:0px;}
        #nav1  li{padding-left:0px; border-bottom:0px;}
        #nav1  li a{height:40px;line-height:20px; }
    </style>
</head>
<body>
     <div class="clear"></div>
...
<div class="clear"></div>
    ...
    <div class="ww">
        <div class="article-right">
			<div >
				<a href="<?php echo U('wrt');?>" class="wrt">写文章</a>
                <div class="wd-my">
                    <div class="user-info">
                        <a href=""><img style="width:40px;" id="id" class="img-circle fl" src="/AP1/Uploads/<?php echo ($_SESSION['home']['img']); ?>"></a>
                        <p><a href=""><?php echo ($_SESSION['home']['name']); ?></a></p>
                        <!--<a class="mypoint" href="">我的积分:</a>-->
                    </div>
		...
		<div class="article-left">
			<div class="article-nav clearfix">
				<ul id="nav1" class="nav nav-pills">
	        		<li  role="presentation" class="active"><a href="<?php echo U('index','pid=0&qid='.$qid);?>"  >全部</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=1&qid='.$qid);?>" >前端开发</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=2&qid='.$qid);?>" >后端开发</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=3&qid='.$qid);?>" >程序人生</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=4&qid='.$qid);?>" >设计</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=5&qid='.$qid);?>" >移动开发</a></li>
		        	<li role="presentation"><a href="<?php echo U('index','pid=6&qid='.$qid);?>" >其它</a></li>
		        </ul>
			</div>
		

			<div id="nav2" class="article-bar clear">
				<a href="<?php echo U('index','qid=0&pid='.$pid);?>" class="sort-item active">最新</a>
	            <a href="<?php echo U('index','qid=1&pid='.$pid);?>" class="sort-item ">热门</a>
            </div>
            
            <script>
                $("#nav1 li").eq($.cookie("art_pid")).addClass('active').siblings().removeClass('active');
                $("#nav2 a").eq($.cookie("art_qid")).addClass('active').siblings().removeClass('active');
            </script>



            <div class="article-allcontent" >
                
                <?php if(is_array($list)): foreach($list as $key=>$val): ?><div class="article-percontent">
					
					<div class="item-img">
                        <a href="<?php echo U('detail','bw=1&id='.$val[id]);?>"><img style="width:140px;height:140px;" src="/AP1/Uploads/<?php echo ($val["name"]); ?>" ></a>
					</div>

					<div class="item-text">
                        
                        <h3><a href="<?php echo U('detail','bw=1&id='.$val[id]);?>"><b><?php echo ($val["title"]); ?></b></a></h3>
						
                        <div  class="item-context"><p><?php echo (htmlspecialchars_decode($val["content"])); ?></p></div>

						<div class="item-bd">
							<ul class="info-left">
								<li class="header">
                            <a href="<?php echo U('myclub/index');?>之后完善"><img style="width:20px;height:20px;" id="id" class="img-circle img" src="/AP1/Uploads/<?php echo ($val["user_pic"]); ?>" >
								<?php echo ($val["user_name"]); ?></a>
								</li>
                                <li class="tag">
                                <a href="<?php echo U('index','pid='.$val['cate_id']);?>"><?php echo ($val["tag"]); ?></a>
                                </li>
                                <li class="发表时间"><?php echo ($val["time"]); ?></li>
                                <li class="浏览数"><?php echo ($val["ans_bw"]); ?> 浏览数</li>
							</ul>
							<div class="info-right">
							
                                <div class="item-judge "><?php echo ($val["ans_count"]); ?> 评论</div>		
							</div>
						</div>
