...
<div class="clear"></div>
	...
	<div class="main">
	    <div class="ww">
	        ...
	        <div class="dt-main">
                <div class="dt-nav"><a href="<?php echo U('index','id=0');?>">全部问题</a></div>
                <script>
                    if(<?php echo ($qlist["zz_id"]); ?>==0){
                        $('.dt-nav').append(' > <a href="<?php echo U('index','id=1');?>">技术问答</a>');
                    }else{
                        $('.dt-nav').append(' > <a href="<?php echo U('index','id=2');?>">课堂问答</a>');
                    }
                </script>
                ...
                <div class="dt-header clearfix">
                    ...
                    <a class="de-header-left" href="">
                        <img style="width:40px;height:40px;"  class="img-circle img" src="/AP1/Uploads/<?php echo ($qlist["user_pic"]); ?>">
                    ...
                    <script>                        
                        ...
                        $('.glyphicon-heart').click(function(){
                            if($('.header-care').html().length==2){
                                $('.glyphicon-heart').css("color","red");
                                $('.header-care').html("已关注");
                                $.get("<?php echo U(docare);?>", { care_id: 1, ques_id:"<?php echo ($qlist['id']); ?>"} );
                            }else{
                                $('.glyphicon-heart').css("color","#CED1D1");
                                $('.header-care').html("关注");
                                $.get("<?php echo U(docare);?>", { care_id: 0, ques_id:"<?php echo ($qlist['id']); ?>"} );
                            };
                        });
                ...
                <?php if(is_array($alist)): foreach($alist as $key=>$val): ?><div class="dt-comment">
                    ...
                    <div class="dt-per-comment">
                        <div class="cm-header">
                            <a href="">
                                <img style="width:40px;height:40px;"  class="img-circle img" src="/AP1/Uploads/<?php echo ($val["user_pic"]); ?>">
                    ...
                    <div class="cm-replyall">
                        ...
                        <div class="cm-replyper">
                            <a class="cm-replyper-header" href="<?php echo ($val1["user_id"]); ?>"><img style="width:40px;height:40px;" class="img-circle img" src="/AP1/Uploads/<?php echo ($val1["reply_pic"]); ?>"></a>
                ...
                <div class="dt-input">
                    ...
                    <div class="me-header">
                        <img class="img-circle myimg" style="width:40px;" src="/AP1/Uploads/<?php echo ($_SESSION['home']['img']); ?>">
                    </div>
                    <script>
                        $a = '<?php echo ($_SESSION['home']['id']); ?>'; 
                        if($a==''){ $(".myimg").attr({src:"/AP1/Public/img/avatar_default.png"});}
