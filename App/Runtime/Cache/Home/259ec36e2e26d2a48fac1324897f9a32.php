...
<div class="wcontainer set-space-cont clearfix">
  <div class="setting-left l">
    <ul class="wrap-boxes">
      <li class="nav-active">
        <a href="<?php echo U('perset');?>" class="onactive">个人资料</a>
      </li>
      <li>
         <a href="<?php echo U('settou');?>">头像设置</a>
       </li>

      <li>
        <a href="<?php echo U('setpwd');?>">修改密码</a>
      </li>
...
<div id="setting-profile" class="setting-wrap setting-profile">
    <form id="profile" action="<?php echo U('perset');?>" method="post">
        <div class="wlfg-wrap">
            <label class="label-name">昵称</label>
            <div class="rlf-group">
                <input type="hidden" name="id"  class="rlf-input rlf-input-nick" value="<?php echo ($list["id"]); ?>">
                <input type="text" name="nick"  class="rlf-input rlf-input-nick" value="<?php echo ($list["nick"]); ?>" placeholder="请输入昵称.">
            ...
            <div class="rlf-group">
                <select class="rlf-select" name="job" hidefocus="true" id="job">
                    <option value="">请选择职位</option>
                                            <option value="1" <?php echo ($list['job'] ==1?'selected':''); ?>>页面重构设计
                                            <option value="6" <?php echo ($list['job'] ==6?'selected':''); ?>>Web前端工程师
                                            <option value="5" <?php echo ($list['job'] ==5?'selected':''); ?>>JS工程师
                                            <option value="8" <?php echo ($list['job'] ==8?'selected':''); ?>>PHP开发工程师</option>
                                            <option value="11" <?php echo ($list['job'] ==11?'selected':''); ?>>JAVA开发工程师</option>
                                            <option value="7" <?php echo ($list['job'] ==7?'selected':''); ?>>移动开发工程师</option>
                                            <option value="9" <?php echo ($list['job'] ==9?'selected':''); ?>>软件测试工程师</option>
                                            <option value="10" <?php echo ($list['job'] ==10?'selected':''); ?>>Linux系统工程师</option>
                                            <option value="2" <?php echo ($list['job'] ==2?'selected':''); ?>>交互设计师</option>
                                            <option value="3" <?php echo ($list['job'] ==3?'selected':''); ?>>产品经理</option>
                                            <option value="4" <?php echo ($list['job'] ==4?'selected':''); ?>>UI设计师</option>
                                            <option value="12"<?php echo ($list['job'] ==12?'selected':''); ?>>学生</option>
                                            <option value="13"<?php echo ($list['job'] ==13?'selected':''); ?>>其他</option>
                                    </select>
                <p class="rlf-tip-wrap"></p>
            </div>
        </div>
        ...
        <div class="wlfg-wrap">
            ...
            <div class="rlf-group rlf-radio-group">
                <label><input type="radio" hidefocus="true" value="2" name="sex" <?php echo ($list['sex'] ==2?'checked':''); ?>>保密</label>
                <label><input type="radio" hidefocus="true" value="1" name="sex" <?php echo ($list['sex'] ==1?'checked':''); ?>>男</label>
                <label><input type="radio" hidefocus="true" value="0" name="sex" <?php echo ($list['sex'] ==0?'checked':''); ?>>女</label>
            </div>
            <p class="rlf-tip-wrap"></p>
        </div>
        <div class="wlfg-wrap">
            ...
            <div class="rlf-group">
                <textarea name="sign"  id="aboutme" cols="30" rows="5" class="textarea"></textarea>
                <p class="rlf-tip-wrap"></p>
            </div>
        </div>
        <div class="wlfg-wrap">
            <div class="rlf-group">
                <input type="submit" style="width:415px" id="profile-submit" aria-role="button" class="rlf-btn-green btn-block profile-btn" value="保存" />
            </div>
        </div>
    </form>
</div>
