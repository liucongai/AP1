...
<link rel="stylesheet" type="text/css" href="/AP1/Public/css/saved_resource_pl.css" />
    ...
    <div class="program-wrap clearfix">
        <div class="program-main">
            ...
            <div class="course-list job-route-list">
                <ul class="clearfix">
                    <?php if(is_array($planlist)): foreach($planlist as $key=>$val): ?><li id="program_<?php echo ($val["id"]); ?>">
                            <a href="<?php echo U('plandetail',array('id'=>$val['id']));?>" title="">
                                <div class="course-list-img">
                                    <img width="240" height="180" alt="" src="/AP1/Uploads/<?php echo ($val["path"]); ?>">
                                </div>
                                <h5>
                                ...
                                <div class="tips">
                                    <span class="l"><?php echo ($val["cou_num"]); ?>门课程</span>
                                    <span class="l ml20"><?php echo ($val["per_num"]); ?></span>
                                </div>
                            </a>
            ...
            <div>
                    ...
                    <div class="bd">
                        <ul class="plan_mask">
                            <li class="course-nav-item">
                                <a href="<?php echo U('index',array('px_id'=> null));?>">全部</a>
                            </li>
                            <?php if(is_array($catelist)): foreach($catelist as $key=>$vol): ?><li class="course-nav-item ">
                                    <a href="<?php echo U('index?px_id='.$vol['id']);?>"><?php echo ($vol["name"]); ?></a>
                                </li><?php endforeach; endif; ?>
                        </ul>
                    </div>
                </div>
                <div class="course-tool-bar clearfix">
                    <div class="tool-left l">
                        <a href="http://www.imooc.com/course/program?sort=last" class="sort-item active">最新</a>
                        <a href="http://www.imooc.com/course/program?sort=pop" class="sort-item">最热</a>

                    </div>
                    <div class="tool-right r">
                                                    <span class="tool-item">

                                                                                                                                    <a href="http://www.imooc.com/course/program?hide=1" class="hide-learned tool-chk ">隐藏已参加计划
                                                                                                                                    </a>
                            </span>
                        ...
                        <span class="tool-item tool-pager">
                                ...
                                <b class="pager-cur">1</b>/<em class="pager-total">2</em>
                                                        ...
                                                        <a href="http://www.imooc.com/course/program?page=2" class="pager-action pager-next hide-text">下一页</a>
            ...
            <div class="course-list salary-raise program-medias">
                <ul class="clearfix">
                    <?php if(is_array($planlist_a)): foreach($planlist_a as $key=>$val): ?><li class="course-one">
                            <a href="<?php echo U('plandetail2',array('id'=>$val['id']));?>" title="<?php echo ($val["name"]); ?>">
                                <div class="course-list-img">
                                    <img width="240" height="180" alt="" src="/AP1/Uploads/<?php echo ($val["path"]); ?>">
                                </div>
                                <h5>
...
<script>
    $('.plan_mask .course-nav-item').eq($.cookie("pl_px")).addClass('on');
</script>
