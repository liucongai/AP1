	...
	<div class="main  ">
		<div class="ww">
			...
			<div class="wd-main">
                ...
                <div style="height:30px; line-height:30px;" id="nav1" class="classify-nav clearfix">
                    <ul>
                        <li class="current"><a href="<?php echo U('index','id=0&cid='.$cid);?>"   >全部问题</a></li>
                        <li><a href="<?php echo U('index','id=1&cid='.$cid);?>" >技术问答</a></li>
                        <li><a href="<?php echo U('index','id=2&cid='.$cid);?>" >课堂问答</a></li>
                ...
                <div class="tag-nav">
                    <ul id="nav2" class="nav nav-pills">
                        <li role="presentation" class="active" ><a  href="<?php echo U('index','cid=0&id='.$id);?>">最新</a></li>
                        <li role="presentation"  ><a  href="<?php echo U('index','cid=1&id='.$id);?>">热门</a></li>
                        <li role="presentation"  ><a  href="<?php echo U('index','cid=2&id='.$id);?>">等待回复</a></li>
			    	</ul>
                </div>

                <script>
                    $("#nav1 li").eq($.cookie("wd_id")).addClass('current').siblings().removeClass('current');
                    $("#nav2 li").eq($.cookie("wd_cid")).addClass('active').siblings().removeClass('active');
                </script>
