        ...
        <div class="main">
            <div class="ww">
                    ...
                    <div class="user-info-me">
                        ...
                        <span><small><?php echo ($myjob); ?></small></span>
                    </div>
                    <div class="use-sign">
                ...
                <div style="display:inline;" class="myclub-main fr">
                    <div  id="nav1" class="wd-nav">
                        <a class="wd-me wd-on" href="<?php echo U('myopus');?>">我的作品</a>
                        <a class="wd-me" href="<?php echo U('myopuscare');?>">收藏</a>
                        
                        
                        <a class="wd-new fr" href="<?php echo U('Opus/create');?>"><i class="glyphicon glyphicon-plus" ></i>创建作品</a>
                    </div>
                    ...
                    <!--作品-->
                    <div style="display:inline;" class="wd-ques">
                         <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><div class="wd-pre">

                            <div class="wd-l fl">
                                <h4><i class="glyphicon glyphicon-file" ></i><a href="<?php echo U('Opus/detail','bw=1&id='.$val['id']);?>"><?php echo ($val["title"]); ?></a></h4>
                                <div class="wd-addon">
                                    <span>提问时间:<?php echo ($val["time"]); ?></span>
                                    <span class="wdtag">
                                    <?php if(is_array($val['tag'])): foreach($val['tag'] as $key=>$val1): ?><a class="wdtag-a " href="<?php echo U('Opus','cid='.$val1['id']);?>"><?php echo ($val1["name"]); ?></a><?php endforeach; endif; ?>
                                </span>
                                </div>
                               
                            </div> 
                            <div class="actques  fr">
                                <a class="btn btn-primary" href="<?php echo U('Opus/detail','bw=1&id='.$val['id']);?>">查看作品</a>
                                <a class="btn btn-success" href="<?php echo U('delopus','id='.$val['id']);?>">删除作品</a> 
                            </div>
                            <div style="display:inline;" class="wd-r fr">                
                                <a href="<?php echo U('Opus/detail','bw=1&id='.$val['id']);?>">
                                    <div class="ans-wen">
