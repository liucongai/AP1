...
<script>
    ...
    <div class="course-info-main clearfix w">
        <div class="info-bar clearfix">
            ...
            <a href="<?php echo U('learn?lesson_id='.$lesson['id']);?>" class="btn-red start-study-btn r"><?php echo ($button); ?></a>
        </div>
        <div class="content-wrap">
            <div class="content">
                <div class="course-brief">
                    <h3 class="ctit">课程介绍</h3>
                    <p class="auto-wrap"><?php echo ($lesson["lesson_desc"]); ?></p>
                </div>
                <div class="course-outline">
                    <div class="bar clearfix">
                        ...
                        <ul class="tools l">
                            <li class="l">
                                <?php echo ($sums); ?><i class="icon-video"></i><span>个视频</span>
                            </li>
                        </ul>
                    </div>
                    <div class="outline-list">
                        <ul>
                            <?php if(is_array($z_detail)): foreach($z_detail as $key=>$val): ?><li class="chapter clearfix ">
                                    <i class="chapter-icon"></i>
                                    <div class="chapter-bd l">
                                        <h5 class="name"><?php echo ($val["zh_name"]); ?></h5>
                                        <p class="desc"><?php echo ($val["zh_desc"]); ?></p>
                                    </div>
                ...
                <div class="bd">
                    <div class="box mb40">
                        ...
                        <div class="teacher-info">
                            <a href="/space/teacher/id/1352822" target="_blank">
                                <img src='' width='80' height='80' />
                            </a>
                            <span class="tit">
                            <a href="/space/teacher/id/1352822" target="_blank">JesonChen</a><i class="icon-imooc"></i>
