                ...
                <div style="display:inline;" class="myclub-main fr">
                    ...
                    <div style="display:inline;" class="wd-ques">
                         <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><div class="wd-pre">
                            ...
                            <div class="wd-l fl">
                                <h4><i class="glyphicon glyphicon-file" ></i><a href="<?php echo U('Opus/detail','bw=1&id='.$val['id']);?>"><?php echo ($val["qt"]); ?></a></h4>
                                <div class="wd-addon">
                            ...
                            <div class="actques  fr">
                                ...
                                <a class="btn btn-success" href="<?php echo U('delopuscare','id='.$val['id']);?>">取消关注</a> 
                            </div>
