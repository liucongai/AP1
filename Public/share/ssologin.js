function SSOController() {
    ...
    var crossUrlCount = 0;
    var formParam = {};
	var loginApi = "http://passport.imooc.com/user/login";
    var registerApi = "http://passport.imooc.com/user/register"   

    this.verifyCodeUrl = 'http://passport.imooc.com/user/getverifycode'
    this.checkVerifyUrl='http://passport.imooc.com/user/loginverifyshow'
    this.checkVerifyCode='http://passport.imooc.com/user/verifycheck'
    this.checkUserName='http://passport.imooc.com/user/checkusername'
    this.checkNickName='http://passport.imooc.com/user/checknickname'
